...
public class MyContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.example.contentprovidertest.MyContentProvider";
    static final String URL = "content://"+PROVIDER_NAME+"/TelephoneBook";
    static final Uri URI = Uri.parse(URL);
    public TelephoneBookDBManager dbManager;
    ...
    public boolean onCreate() {
        ...
        dbManager = TelephoneBookDBManager.getInstance(getContext());
